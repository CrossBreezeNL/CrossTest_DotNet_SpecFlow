...
namespace CrossTestDocumenter
{
    class CrossTestDocumenter
    {
        ...
        static void Main(string[] args)
        {
            ...
            Assembly configAssembly = Assembly.LoadFrom("C:\\GIT\\Repos\\CrossBreeze\\CrossTest\\CrossTest\\CrossTestDocumenter\\bin\\Debug\\CrossBreeze.CrossTest.SpecFlow.dll");
            ...
            (
                configType,
                "C:\\GIT\\Repos\\CrossBreeze\\CrossTest\\CrossTest\\Documentation\\generator\\Model\\CrossTestConfig.xml"
            );
